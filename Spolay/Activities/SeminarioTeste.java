...
import MaratonaJava.Spolay.Activities.classesAtividades.AlunosS;
import MaratonaJava.Spolay.Activities.classesAtividades.ProfessoresS;
import MaratonaJava.Spolay.Activities.classesAtividades.Seminario;
...
public class SeminarioTeste {
    public static void main(String[] args) {
        ...
        Seminario seminario = new Seminario("EcoXP", local);
